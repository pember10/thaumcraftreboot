...
public class ThaumcraftFluidTypes {
    ...
    public static final RegistryObject<FluidType> SOAP_WATER_FLUID_TYPE = register("soap_water_fluid", FluidType.Properties.create().viscosity(0).sound(SoundAction.get("drink"), SoundEvents.HONEY_DRINK));
