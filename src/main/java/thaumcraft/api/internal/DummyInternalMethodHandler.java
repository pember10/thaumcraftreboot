...
public class DummyInternalMethodHandler implements IInternalMethodHandler {
    ...
    @Override
    public AspectList getBonusObjectTags(ItemStack itemStack, AspectList aspects) {
        return null;
    }
    ...
    @Override
    public boolean consumeVisFromWand(ItemStack wand, Player player, AspectList cost, boolean doConsume,
            boolean isCrafting) {
        return false;
    }

    @Override
    public boolean consumeVisFromWandCrafting(ItemStack wand, Player player, AspectList cost, boolean doConsume) {
        return false;
    }
